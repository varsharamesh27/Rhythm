...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ message?: string }> }) {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-amber-50 px-4 py-10">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <p className="text-sm text-zinc-600">Use Supabase magic-link auth to keep your check-ins tied only to your account.</p>
        </CardHeader>
        <CardContent>
