    ...
    <main className="grid min-h-screen place-items-center px-4 py-10 text-zinc-950 dark:text-zinc-50">
      ...
      <Card className="w-full max-w-md border-t-4 border-t-rose-500 dark:border-t-teal-400">
        <CardHeader>
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-300">Use Supabase magic-link auth, or try the local demo workspace while you set up your database.</p>
        </CardHeader>
          ...
          {demoMode ? (
            <form action={enterDemoWorkspace} className="grid gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-zinc-800">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">Open a seeded workspace, add today&apos;s information, and watch the dashboard update locally.</p>
              </div>
